...
{
    public class PassThroughConnection : IBasicCommunicationService, ISenderService, IReceiverService
    {
        [NotNull]
        private readonly ICommunicationService _transmitService;

        [NotNull]
        private readonly ICommunicationService _receiverService;
        ...
        {
            _receiverService = new NetworkPassThrough(socketPipe.Input, connectionPipe.Output, connectionClosed);
            _transmitService = new NetworkPassThrough(connectionPipe.Input, socketPipe.Output, connectionClosed);
        }

        /// <inheritdoc />
        public ICommunicationService Sender => _transmitService;

        /// <inheritdoc />
        public ICommunicationService Receiver => _receiverService;
        ...
        private class NetworkPassThrough : ICommunicationService
        {
            [NotNull]
