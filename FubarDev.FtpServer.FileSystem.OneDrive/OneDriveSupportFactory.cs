// <copyright file="OneDriveSupportFactory.cs" company="Fubar Development Junker">
...
namespace FubarDev.FtpServer.FileSystem.OneDrive
{
    ...
    /// </summary>
    public class OneDriveSupportFactory : IRequestFactory
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OneDriveSupportFactory"/> class.
        /// </summary>
        ...
        public OneDriveSupportFactory([NotNull] OAuth2Client oAuth2Client, [NotNull] Func<IRestClient> restClientCreateFunc, [NotNull] Func<ITemporaryData> createTempDataFunc)
        {
        ...
        /// </remarks>
        [CanBeNull]
        public Action<HttpWebRequest> ConfigureWebRequest
        { get; set; }
        ...
        public IRestClient CreateRestClient(Uri baseUri)
        {
            ...
            client.BaseUrl = new Uri($"{OneDriveService.DriveApiPath}");
